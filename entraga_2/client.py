    ...
    while running:
        try:
            ...
            if message == '//ACK//':
                ...
                ACK = False
                NACK = False
                client_socket.sendto(acknowledgement.encode("ISO-8859-1"), database.server_address_tuple)  # envia o pacote pro backend
                #print(f"hello + {len(received_messages[package_quantity])}")
